...
Init = function(self)
	self:SetDrawBackground(false):SetTextColor(TextColor):SetHighlightColor(HighlightColor):SetFont("HS.18"):SetPlaceholderColor(PlaceholderColor):SetCursorColor(TextColor)
end})
