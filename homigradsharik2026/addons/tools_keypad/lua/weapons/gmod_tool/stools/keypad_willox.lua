if (SERVER) then
	...
	RunConsoleCommand("sbox_maxkeypads","50")
end
...
if CLIENT then
	local function ResetSettings(ply)
		...
		ply:ConCommand("keypad_willox_length_granted 1")
	...
	function TOOL.BuildCPanel(CPanel)
		...
		local granted = vgui.Create("DForm")
			...
			granted:NumSlider("Hold Length:", "keypad_willox_length_granted", 0.1, 5, 2)
