...
function PageSub.Open(frame)
    ...
    if colorProfile then
        local r,g,b
        if colorProfile.x ~= nil then
            local mul = colorProfile.x > 1 and colorProfile.y > 1 and colorProfile.z > 1 and 1 or 255
            r,g,b = colorProfile.x * mul,colorProfile.y * mul,colorProfile.z * mul
        elseif colorProfile.r ~= nil then
            r,g,b = colorProfile.r,colorProfile.g,colorProfile.b
        elseif colorProfile[1] ~= nil then
            r,g,b = colorProfile[1],colorProfile[2],colorProfile[3]
        end

        if r and g and b then mixer:SetColor(Color(r,g,b)) end
    end
