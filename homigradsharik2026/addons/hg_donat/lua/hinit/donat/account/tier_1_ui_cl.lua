...
function Page.Open(frame)
    ...
    function avatarHTML:Update()
        ...
        function avatar:Draw(w,h)
            ...
            local r,g,b
            if col.x ~= nil then
                local mul = col.x > 1 and col.y > 1 and col.z > 1 and 1 or 255
                r,g,b = col.x * mul,col.y * mul,col.z * mul
            elseif col.r ~= nil then
                r,g,b = col.r,col.g,col.b
            elseif col[1] ~= nil then
                r,g,b = col[1],col[2],col[3]
            end

            col = Color(r or 255,g or 255,b or 255,64)
