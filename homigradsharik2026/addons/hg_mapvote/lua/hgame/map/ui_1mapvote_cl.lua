...
local function CreateIconsPanel(frame,mapName)
    ...
    function panel:Update()
        ...
        for steamid,info in pairs(RTVVote[mapName] or {}) do
            //for i = 1,8 do
...
function RTVUI_CreateMapVote(page)
    ...
    function screenshoots:Draw(w,h)
        ...
        local screenshoots = mapInfo.screenshoots
    ...
    function extend:Draw(w,h)
        ...
        draw.SimpleText(L("rtv_extend_button"),"HS.45",w/2,h/2,nil,TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
    end
    ...
    function random:Draw(w,h)
        ...
        draw.SimpleText(L("rtv_random_button"),"HS.45",w/2,h/2,nil,TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
    end
