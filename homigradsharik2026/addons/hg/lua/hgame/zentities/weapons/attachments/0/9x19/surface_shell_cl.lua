local Index_Registry = function(name,manual) surfaceWorld.Index_Registry(name,"sound","shell_9mm",manual) end
...
local manual_soil = {
    "weapons/shells/9mm_shell_soil1.wav",
    "weapons/shells/9mm_shell_soil2.wav",
    "weapons/shells/9mm_shell_soil3.wav"
}

local manual_cocrete = {
    "weapons/shells/9mm_shell_concrete1.wav",
    "weapons/shells/9mm_shell_concrete2.wav",
    "weapons/shells/9mm_shell_concrete3.wav"
}

local manual_wood = {
    "weapons/shells/9mm_shell_wood1.wav",
    "weapons/shells/9mm_shell_wood2.wav",
    "weapons/shells/9mm_shell_wood3.wav"
}

local manual_metal = {
    "weapons/shells/9mm_shell_metal1.wav",
    "weapons/shells/9mm_shell_metal2.wav",
    "weapons/shells/9mm_shell_metal3.wav"
}
