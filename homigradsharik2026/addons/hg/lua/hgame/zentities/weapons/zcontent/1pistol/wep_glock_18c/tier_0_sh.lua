local SWEP = oop.Reg("wep_glock_18c","wep_glock_17",true)
...
SWEP.Primary.Sound = {
    outdoor_close = sound.CreateFormatedList("weapons/eft/glock/glock18_outdoor_close_",1,2,".ogg"),
    outdoor_distant = sound.CreateFormatedList("weapons/eft/glock/glock18_outdoor_distant_",1,2,".ogg"),
    indoor_close = sound.CreateFormatedList("weapons/eft/glock/glock18_indoor_close_",1,2,".ogg"),
    indoor_distant = sound.CreateFormatedList("weapons/eft/glock/glock18_indoor_distant_",1,2,".ogg"),
