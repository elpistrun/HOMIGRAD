local SWEP = oop.Reg("wep_vpo215","hg_wep",true)
...
SWEP.Primary.AmmoCalibre = "762x39"
SWEP.Primary.ShellModel = "models/weapons/arc9/darsu_eft/shells/762x51.mdl"
SWEP.Primary.MagazineModel = "models/weapons/arc9/darsu_eft/mods/mag_vpo215.mdl"
SWEP.Primary.MagazineModelAng = Angle(0,-90,0)

SWEP.MuzzlePos = Vector(0,0,0.26)

SWEP.Primary.Sound = {
    outdoor_close = {"weapons/eft/vpo215/vpo215_fire_close.ogg"},
    outdoor_distant = {"weapons/eft/vpo215/vpo215_fire_distant.ogg"},
    indoor_close = {"weapons/eft/vpo215/vpo215_fire_indoor_close.ogg"},
    indoor_distant = {"weapons/eft/vpo215/vpo215_fire_indoor_distant.ogg"},

    outdoor_close_silence = {"weapons/eft/vpo215/vpo215_fire_silenced_close.ogg"},
    outdoor_distant_silence = {"weapons/eft/vpo215/vpo215_fire_silenced_distant.ogg"},
    indoor_close_silence = {"weapons/eft/vpo215/vpo215_fire_silenced_indoor_close.ogg"},
    indoor_distant_silence = {"weapons/eft/vpo215/vpo215_fire_silenced_indoor_distant.ogg"}
}

SWEP.Primary.SoundEmpty = "weapons/eft/dvl10/dvl_magbutton.ogg"

SWEP:TableLink("wmData",{
    model = "models/weapons/arc9/darsu_eft/c_vpo215.mdl",
    vec = Vector(9,-6,-4.5),
    ang = Angle(0,0,0),
    chamberBodygroup = 6
})
...
SWEP.CameraPos = Vector(-40,0,0.7)
SWEP.CameraRecoil = 2
