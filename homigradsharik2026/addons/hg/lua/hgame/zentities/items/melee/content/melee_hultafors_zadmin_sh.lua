...
SWEP.Secondary.Throw = "melee_hultafors_throw"
...
SWEP.AnimationList["attack_throw_start"] = {
    ...
    OnChangeEye = function(self,tpikMatrix,Pos,Ang,wmVector,wmAngle)
        wmAngle:Set(math.EvalGraphAngle(self:GetCycle("animation"),graphThrowAngle))
    end,
