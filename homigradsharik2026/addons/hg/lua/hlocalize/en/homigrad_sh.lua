...
l.timeoutmenu_changemap = "Changing map"
l.timeoutmenu_timeout = "There may be a failure"

l.timeoutmenu_timeout_title = "Server has not responded for: %s seconds."
l.timeoutmenu_timeout_desc = "If this continues, we will restart."

l.timeoutmenu_servernotonline = "Server not active"

l.timeoutmenu_send_title = "Waiting for reply"
l.timeoutmenu_send_desc = "Sending a request for server activity data"

l.timeoutmenu_error_desc = "We will start the request again in %s seconds."
l.timeoutmenu_server_desc = "Start a second request in %s seconds."

l.timeoutmenu_serveralive_title = "Server active"

l.max_killed = "Maximum number of kills: %s"

l.car_enter = "Enter by vehicle"
l.car_lock_by = "%s locked vehicle"
