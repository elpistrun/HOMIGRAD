...
net.ReceiveBig("AdvDupe2_SendGhosts", 	function(len, ply, len2)
	AdvDupe2.RemoveGhosts()
	AdvDupe2.GhostToSpawn = {}
...
net.ReceiveBig("AdvDupe2_AddGhost", function(len, ply, len2)
...
net.ReceiveBig("AdvDupe2_StartGhosting", function()
	AdvDupe2.StartGhosting()
end)

net.ReceiveBig("AdvDupe2_RemoveGhosts", AdvDupe2.RemoveGhosts)
