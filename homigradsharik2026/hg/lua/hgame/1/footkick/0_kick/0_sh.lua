...
function ANM:Start()
    ...
    local slotGesture = self.slot.slotGesture
    ply:AddVCDSequenceToGestureSlot(slotGesture,ply:LookupSequence(self.sequence),(self.startCycle or 0) + 1 - (self.delay - Ping(ply)) / self.delay,true)
    ply:SetLayerDuration(slotGesture,self.delay * 1.5)
