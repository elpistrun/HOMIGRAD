...
CLASS.weapons = {"weapon_transmitter","med_band_big","med_kit","med_painkiller","weapon_handcuffs","weapon_taser","weapon_hg_flashbang","weapon_police_bat"}
...
local outfit = util.JSONToTable('{"09_watch":["watch","black"],"04_foot":["foot_boots_track","black"],"06_headmask":[],"08_gloves":[],"13_body":["male_09_body","white"],"12_face":["male_09_face","default"],"02_upper":[],"05_hair":[],"01_top":["top_overshirtlong","black"],"07_scarf":["maske","black"],"03_lower":["lower_cargo","black"],"11_sunglasses":["sunglasses_eye","black"],"10_hat":[]}')

local hairs = {
	"hair_kepka","hair_looseblonde","hair_shortscruffy","hair_slickedback","hair_thinningshort"
}
...
function CLASS:On()
	...
	armorGame.GiveEntity(self,"vest_paca",{color = color})
	...
	local outfit = util.tableCopy(outfit)
	outfit[OUTFITPLAYER_HAIR] = {hair,math.random(1,2) == 2 and "brown" or "black"}
...
function CLASS:Event(name,a1)
	...
	if name == "inventory close" then
		if a1.roleT then
			event.Call("Player Find Traitor",self,a1)
